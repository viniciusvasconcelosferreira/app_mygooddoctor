        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm">
                    <a class="opacity-3 text-dark" href="{{route('dashboards.home')}}">
                ...
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                                       href="javascript:;">{{ucfirst(explode('.',request()->route()->action['as'])[0])}}</a>
                </li>
                <li class="breadcrumb-item text-sm text-dark active"
                    aria-current="page">{{ucwords(explode('/',request()->path())[1])}}</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">{{ucwords(explode('/',request()->path())[1])}}</h6>
        </nav>
